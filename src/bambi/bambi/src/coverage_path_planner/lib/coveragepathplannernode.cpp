...
CoveragePathPlannerNode::CoveragePathPlannerNode(const ros::NodeHandle &nodeHandle)
    ...
    m_publisherPath = m_nodeHandle.advertise<bambi_msgs::Path>("/bambi_coverage_path_planner/path", 5, false);

    m_subscriberTriggerPathGeneration = m_nodeHandle.subscribe("/bambi_missioncontroller/trigger_path_generation", 10,
